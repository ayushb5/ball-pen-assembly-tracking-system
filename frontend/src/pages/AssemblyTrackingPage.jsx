                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-3 text-xs">
                      ...
                      {stageItem.startedTime && (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-slate-100 text-slate-600">
                          <Clock className="h-3.5 w-3.5 text-slate-400" />
                          Started: {formatDateTime(stageItem.startedTime)}
                        </span>
                      )}
                      {stageItem.completedTime && (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-emerald-50 text-emerald-700 border border-emerald-200">
                          <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" />
                          Completed: {formatDateTime(stageItem.completedTime)}
                        </span>
                      )}
                    </div>
